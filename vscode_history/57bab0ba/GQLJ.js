...
const AjoutLivre = () => {
  const [livre, setLivre] = useState({
    num: "",titre: "",dateEdition: "",genre: "",prix: ""});
    ...
    <div>
      ...
      <form onSubmit={ajouterLivre}>
        ...
        <div>
          ...
          <button type="button" onClick={resetListe}>Réinitialiser</button>
        </div>
      </form>
      ...
      <ul>
        {listeLivres.map((l, index) => (
          <li key={index}>
            Num: {l.num}, Titre: {l.titre}, Date: {l.dateEdition}, Genre: {l.genre}, Prix: {l.prix} dh
          </li>
        ))}
      </ul>
    </div>
