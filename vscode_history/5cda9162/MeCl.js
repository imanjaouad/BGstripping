...
const platforms = {
    ...
    facebook: {
        ...
        color: '#1877f2',
        searchUrl: 'https://www.facebook.com/search/people/?q={username}',
...
// Ouvrir le lien d'une plateforme
function openPlatformLink(platformKey, platformName) {
    ...
    const platform = platforms[platformKey];
    const url = platform.searchUrl.replace('{username}', encodeURIComponent(username));
