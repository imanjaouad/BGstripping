...
<a href="#" style={{ margin: 10,color:"black",fontStyle:"unset"}}>Contact</a>
<div>
<img src={logo} alt="Logo" style={{ width: 80,backgroundColor:"black",height:40,borderRadius:13,marginLeft:30,marginTop:10}} />
</div>
</footer>
);
}
