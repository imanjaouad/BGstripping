...
export default function EtudiaModules() {
  ...
  // Tous les hooks doivent être déclarés AVANT toute condition
  ...
  // Vérification et redirection APRÈS les hooks
  useEffect(() => {
  ...
  // Si pas de sélection, on retourne null après les hooks
  if (!selection || !selection.filiere_id) {
    return null;
  }
