...
export default function EtudiaModules() {
  ...
  // Extraction conditionnelle mais sécurisée
  const filiere_id = selection?.filiere_id;
  const year = selection?.year;
  const filiere = selection?.filiere;

  // TOUS les useEffect doivent être ici, avant tout return
