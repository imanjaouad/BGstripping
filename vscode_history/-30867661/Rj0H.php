...
<div class="container mt-4">
    ...
    <a href="/moduless/create" class="btn btn-success mb-3">
        Ajouter une module
    </a>
        ...
        <tbody>
            @foreach ($moduless as $module)
                <tr>
                    ...
                    <td>
                        <!-- Edit button -->
                        <a href="/moduless/{{ $module->id }}/edit" class="btn btn-primary btn-sm">
                            Edit
                        </a>

                        <!-- Delete button -->
                        <form action="/moduless/{{ $module->id }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
