...
export default function LeftProductCard({ name, description, prix, imageSrc,rotateImage }) {
  return (
    <div className="p-4 max-w-sm rounded-2xl shadow-lg bg-white flex items-center gap-4" style={{
      ...
      <img
        src={imageSrc} style={{width:"200px",height:"173px",position:"revert",transform: rotateImage ? "scaleX(-1)" : "none"}}
        alt={name}
      ...
      <div style={{
        ...
        <button style={{backgroundColor:"#192176",color:"white",width:"103px",borderRadius:"8px",cursor:"move"}}>Buy</button>
        </div>
      </div>
    </div>
