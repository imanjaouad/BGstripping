...
def afficher(theme):
    ...
    for formateur in collection1.find():
        print(f"le numero : {formation['theme']}")
        print(f"le nom : {formation['cout']}")
        print(f"le prénom : {formation['description']}")
        print(f"la specialite : {formation['duree']}")
        print(f"l'email : {        print(f"le téléphone : {formateur['duree']}")
['duree']}")
        print(f"le téléphone : {formateur['duree']}")
