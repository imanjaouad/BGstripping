Voici le code React (**EtudiaLanding.js**) final et corrigé.

J'ai apporté deux corrections importantes :
1.  **Le soulignement** : J'ai appliqué le style `borderBottom` directement sur les mots "Bienvenue" et "Cher Apprenant" via un `<span>`, comme demandé (plus de div séparée).
2.  **Les classes des triangles** : J'ai harmonisé les noms de classes (`edge top`, `edge left`, etc.) pour qu'ils fonctionnent parfaitement avec le CSS que je t'ai donné juste avant.
