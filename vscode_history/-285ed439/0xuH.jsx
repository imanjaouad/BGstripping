...
export default function Groupes() {
    ...
    // تحويل البيانات لضمان التوافق مع SQL
    const payload = {
        ...formData,
        id_filiere: 1, // قيمة افتراضية
        id_proprietaire: 1, // admin1
        annee_formation: parseInt(formData.annee_formation) || 1,
        nbr_semaines: parseInt(formData.nbr_semaines) || 35,
        mh_annuelle: parseInt(formData.mh_annuelle) || 1000
    };
    ...
    if (res.ok) {
        toast.success(editMode ? 'Groupe modifié !' : 'Groupe ajouté ✅');
        setShowModal(false);
        fetchGroupes(); // تحديث الجدول
    } else {
