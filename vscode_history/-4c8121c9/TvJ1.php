...
<div class="mb-3">
    <h1 class="h3 d-inline align-middle">Nouveau module</h1>
</div>
            ...
            <div class="card-body">
                <form action="/modules" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nom" class="form-control" placeholder="Ex: BACKEND" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="masshoraire" class="form-control" placeholder="Technique" required min="1">
                    </div>
                    <div class="mt-3">
