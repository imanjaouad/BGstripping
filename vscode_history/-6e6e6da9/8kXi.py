...
def afficher_employe_par_departement(nom_departement):
    departement = collection2.find({"nom_departement":nom_departement})

    print("employe dans le departement :")
    trouve = False
    for d in departement:
        print(f"nom_departement:{d["nom_departement"]}")
...
""")
        ...
        if choix == "1":
            ...
            nom_departement = input("entrez le id de departement : ")
            afficher_employe_par_departement(nom_departement)
