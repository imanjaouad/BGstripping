    ...
    return (
        <div className="p-4 pt-32 bg-[#f8fafc] min-h-screen font-sans text-black">
            ...
            {/* --- 🖨️ CSS الخاص بالطباعة بالعرض في صفحة واحدة --- */}
                        {/* --- 🖨️ نظام الطباعة الإدارية: صفحة واحدة + عرض كامل --- */}
            <style>{`
                @media print {
                    /* 1. إعدادات الورقة: فرض الوضع الأفقي والهوامش */
                    @page { 
                        size: A4 landscape; 
                    ...
                    table { 
                        width: 100% !important; 
                        table-layout: fixed !important; /* فرض توزيع العرض بالتساوي */
                        border-collapse: collapse !important;
                        margin-top: 10px;
                    }

                    /* 4. التحكم في ارتفاع السطور باش يقدنا ف ورقة وحدة */
                    tr { 
                    ...
                    th, td { 
                        ...
                        height: 1.8cm !important; /* ارتفاع مثالي لـ 6 أيام في صفحة واحدة */
                    }

                    thead th { height: auto !important; background-color: #eee !important; color: black !important; }

                    /* 5. ضبط الخطوط للطباعة */
                    .font-black { font-size: 8.5pt !important; }
                    .text-[10px], .text-[11px] { font-size: 7.5pt !important; }
                    
                    /* إخفاء أي حاجة خارجة على منطقة الطباعة */
                    .overflow-x-auto { overflow: visible !important; }
                }

                /* ستايل الشاشة العادية */
