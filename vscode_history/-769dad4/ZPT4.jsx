...
// --- 🎨 لوحة الألوان المحدثة (10 ألوان متميزة) ---
const SESSION_COLORS = [
    { bg: 'bg-[#e0f2f1]', border: 'border-[#00796b]' }, // Teal
    { bg: 'bg-[#e3f2fd]', border: 'border-[#1976d2]' }, // Blue
    { bg: 'bg-[#fff3e0]', border: 'border-[#f57c00]' }, // Orange
    { bg: 'bg-[#f3e5f5]', border: 'border-[#7b1fa2]' }, // Purple
    { bg: 'bg-[#f1f8e9]', border: 'border-[#689f38]' }, // Green
    { bg: 'bg-[#fff9c4]', border: 'border-[#fbc02d]' }, // Yellow
    { bg: 'bg-[#ffebee]', border: 'border-[#d32f2f]' }, // Red
    { bg: 'bg-[#fce4ec]', border: 'border-[#c2185b]' }, // Pink
    { bg: 'bg-[#e8eaf6]', border: 'border-[#303f9f]' }, // Indigo
    { bg: 'bg-[#f5f5f5]', border: 'border-[#616161]' }, // Grey
];
...
export default function EmploiGrid() {
    ...
    // دالة لتحديد اللون بناءً على معرف التعيين (ID Affectation) لضمان التميز
                                        ...
                                        <tr key={j} className="h-28">
                                            ...
                                            {HEURES.slice(0, -1).map(h => {
                                                ...
                                                if (seance) {
                                                    ...
                                                    // اختيار اللون بناءً على id_affectation
                            ...
                            <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div>
                                    ...
                                    <div className="space-y-2 max-h-80 overflow-y-auto pr-2 custom-scroll text-black">
                                        ...
                                        )) : <p className="text-red-500 text-xs italic text-center py-10 uppercase font-black">Aucun formateur disponible f هاد الوقت !</p>}
                                    </div>
                                </div>
                                <div>
