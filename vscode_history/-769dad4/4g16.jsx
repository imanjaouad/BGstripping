...
export default function EmploiGrid() {
    ...
    return (
        <div className="p-4 pt-32 bg-[#f8fafc] min-h-screen font-sans text-black">
            ...
            <style>{`
                @media print {
                    /* 1. إرغام الطابعة على الوضع الأفقي (Landscape) واستغلال كل مليمتر */
                    @page { 
                        size: A4 landscape; 
                        margin: 0.5cm !important; 
                    }

                    /* 2. تصفير الهوامش وتنظيف واجهة الموقع */
                    body { 
                    ...
                    nav, .navbar, .print\\:hidden, button, select, h1, p.text-gray-400 { 
                        display: none !important; 
                    }
                    
                    /* 3. تمديد الحاوية لتشمل الورقة كاملة بالعرض */
                    #printable-area { 
                        display: flex !important;
                        flex-direction: column !important;
                        width: 100% !important;
                        height: 95vh !important; /* فرض الطول ليتناسب مع صفحة واحدة */
                    ...
                    /* 4. تمديد الجدول لاستغلال المساحة الفارغة */
                    .overflow-x-auto { 
                    ...
                    table { 
                        width: 100% !important; 
                        height: 100% !important; /* الجدول غايتجبد حتى لآخر الورقة */
                        table-layout: fixed !important; 
                        border-collapse: collapse !important;
                        border: 2pt solid black !important;
                    }

                    /* 5. ضبط ارتفاع السطور بالتساوي (6 أيام) */
                    tbody tr { 
                        height: 14% !important; 
                    }
                    ...
                    /* 6. تحسين الخطوط للوضوح الكامل */
                    .font-black { font-size: 9pt !important; }
                    .text-[10px], .text-[11px] { font-size: 8pt !important; }
                    .text-[8pt], .text-[9pt] { font-size: 8pt !important; }

                    /* إظهار التوقيعات والهيدر الإداري بشكل واضح */
                    .hidden.print\\:flex { display: flex !important; margin-bottom: 10px; }
                    .hidden.print\\:grid { display: grid !important; margin-top: 10px; }
                    .hidden.print\\:block { display: block !important; }
                }

                /* ستايل الشاشة العادية (لا يتغير) */
