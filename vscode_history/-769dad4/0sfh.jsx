            ...
            <div className="max-w-full mx-auto space-y-6">
                ...
                {holidays.length > 0 && (
                    <div className="bg-white border-2 border-black p-6 shadow-[10px_10px_0px_rgba(0,0,0,1)] rounded-xl print:hidden">
                        ...
                        {/* --- 🖨️ نظام الضغط العالي للطباعة الإدارية --- */}
            <style>{`
                @media print {
                    /* 1. تصغير الخط العام */
                    body { 
                    ...
                    /* 3. ضغط الهيدر (العنوان) */
                    .mb-6 { margin-bottom: 0.5rem !important; }
                    .pb-4 { padding-bottom: 0.2rem !important; }
                    h2.text-xl { font-size: 14pt !important; margin: 0 !important; }
                    ...
                    th, td { 
                        ...
                        padding: 1px 2px !important; /* مساحة صغيرة جداً داخل الخلايا */
                        height: 0.8cm !important; /* ارتفاع السطر مضغوط */
                    }

                    /* تصغير اليوم (Lundi, Mardi...) */
                    td.bg-gray-50 { width: 1.5cm !important; font-size: 7pt !important; }

                    /* 5. تصغير خطوط المعلومات داخل الحصص */
                    .font-black.text-xs { font-size: 7.5pt !important; line-height: 1 !important; }
                    .text-[10px] { font-size: 6.5pt !important; }
                    .mt-2 { margin-top: 1px !important; }

                    /* 6. ضغط منطقة التوقيعات */
                    .mt-8 { margin-top: 0.5cm !important; }
                    .mb-8 { margin-bottom: 0.3cm !important; }
                    .h-20 { height: 0.8cm !important; } /* تقليص مساحة التوقيع */
                ...
                /* ستايل الشاشة العادية يبقى كما هو */
