    ...
    return (
        <div className="p-4 pt-32 bg-[#f8fafc] min-h-screen font-sans text-black">
            ...
            {/* --- 🪄 نظام الطباعة السحري (Horizontal + 1 Page) --- */}
                       {/* --- 🖨️ نظام الطباعة الإدارية: العرض الكامل + ورقة واحدة --- */}
                        {/* --- 🖨️ نظام الطباعة الإدارية الاحترافي: ورقة واحدة + عرض كامل --- */}
                        {/* --- 🖨️ نظام الطباعة الإدارية الاحترافي: ورقة واحدة + عرض كامل --- */}
            <style>{`
                @media print {
                    /* 1. إعدادات الورقة: فرض الوضع الأفقي (Landscape) */
                    @page { 
                        size: A4 landscape; 
                        margin: 0.3cm !important; 
                    }

                    /* 2. تصفير الهوامش وتنظيف الواجهة */
                    body { 
                    ...
                    /* إخفاء كاع عناصر الموقع (ناخبار، أزرار، الخ) */
                    nav, .navbar, .print\\:hidden, button, select, .Toaster { 
                        display: none !important; 
                    }
                    
                    /* 3. فرض العرض والارتفاع الكامل لمنطقة الطباعة */
                    #printable-area { 
                        display: flex !important;
                        flex-direction: column !important;
                        width: 100% !important;
                        height: 96vh !important; /* جبر كلشي يتجمع فـ 96% من طول الورقة */
                    ...
                    /* 5. الجدول: العرض الكامل وتوزيع الساعات */
                    .overflow-x-auto { 
                    ...
                    table { 
                        width: 100% !important; 
                        height: 100% !important; /* الجدول يتجبد عمودياً */
                        table-layout: fixed !important; 
                        border-collapse: collapse !important;
                        border: 2pt solid black !important;
                    }

                    /* ضبط عرض الأعمدة (اليوم + 10 ساعات) */
                    th:first-child, td:first-child { width: 80px !important; } 

                    /* 6. ارتفاع السطور (6 أيام) */
                    tbody tr { 
                        height: 14% !important; /* تقسيم الارتفاع بالتساوي */
                    }
                    ...
                    /* 7. تحسين وضوح الخطوط */
                    .font-black { font-size: 8.5pt !important; }
                    .text-[10px], .text-[11px], .text-[8pt], .text-[9pt] { 
                        font-size: 8pt !important; 
                        color: black !important;
                    }

                    /* 8. منطقة التوقيعات (Signatures) */
                    .hidden.print\\:grid { 
                    ...
                    .border-t-2 { border-top: 1pt solid black !important; }
                    .h-12 { height: 30px !important; }
                }

                /* ستايل الشاشة العادية (ما كيتقاسش) */
