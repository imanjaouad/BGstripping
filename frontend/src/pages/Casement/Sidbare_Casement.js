...
const SIDEBAR_CSS = `
  ...
  @keyframes sb-csm-slide { from{transform:translateX(-24px);opacity:0} to{transform:translateX(0);opacity:1} }
  @keyframes sb-csm-float { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-6px)} }
  @keyframes sb-csm-glow  { 0%,100%{box-shadow:0 0 0 0 rgba(22,163,74,0)} 50%{box-shadow:0 0 18px 4px rgba(22,163,74,0.22)} }
  @keyframes sb-csm-drift {
  ...
  .sb-csm-particle {
    ...
    animation: sb-csm-drift linear infinite;
  }
  ...
  .sb-csm-logo-ring {
    ...
    animation: sb-csm-glow 3s ease-in-out infinite;
  ...
  .sb-csm-nav-item { margin-bottom:4px; animation:sb-csm-slide .4s ease both; }
  ...
  .sb-csm-link {
    ...
    transition:all .18s; position:relative; overflow:hidden; white-space:nowrap;
  }
  .sb-csm-link:hover {
  ...
  .sb-csm-nav-icon {
    ...
    background:rgba(255,255,255,0.08);
    display:flex; align-items:center; justify-content:center;
    font-size:14px; flex-shrink:0; color:rgba(255,255,255,0.72);
  ...
  .sb-csm-nav-indicator {
    ...
    background:#4ade80; opacity:0; transform:scale(0);
  ...
  .sb-csm-footer-dot {
    ...
    animation:sb-csm-float 2.5s ease-in-out infinite;
  }
